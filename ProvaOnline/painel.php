  ...
  <!-- perfil Section -->
    ...
    <div class=" center" style="width:95%">
      ...
      <div class="w3-container">
        ...
        <p><b>Logradouro:</b> <?php echo($_SESSION['alu_end_log']);?></p>
        <hr>
        <p><b>Bairro:</b> <?php echo($_SESSION['alu_end_bairro']);?></p>
        <hr>
        <p><b>Número:</b> <?php echo($_SESSION['alu_end_num']);?></p>
        <hr>
        <p><b>Complemento:</b> <?php echo($_SESSION['alu_end_comp']);?></p>
        <hr>
        <p><b>Cidade:</b> <?php echo($_SESSION['alu_end_cid']);?></p>
        <hr>
      </div>
    </div>
	</div>
